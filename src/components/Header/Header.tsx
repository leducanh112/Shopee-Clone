    ...
    <div className='bg-[linear-gradient(-180deg,#f53d2d,#f63)] pt-2 pb-5 text-white'>
      <div className='container'>
            ...
            renderPopover={
              <div className='relative rounded-sm border border-gray-200 bg-white shadow-md'>
                <div className='flex flex-col py-2 pr-28 pl-3'>
                  <button className='hover:text-orange px-3 py-2 text-left'>Tiếng Việt</button>
                  <button className='hover:text-orange mt-2 px-3 py-2 text-left'>English</button>
                </div>
              </div>
            }
          >
          ...
          {isAuthenticated && (
            ...
            >
              <div className='mr-2 h-6 w-6 flex-shrink-0'>
                <img src='aa' alt='avatar' className='h-full w-full rounded-full object-cover' />
              </div>
        ...
        <div className='mt-4 grid grid-cols-12 items-center gap-8'>
          ...
          <div className='col-span-1 justify-self-start hover:opacity-90'>
            <Popover
              renderPopover={
                <div className='relative max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md'>
                  <div className='p-2'>
                    ...
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://jira.avepoint.net/secure/useravatar?size=small&ownerId=JIRAUSER37150&avatarId=31808'
                            alt='ảnh sản phẩm'
                    ...
                    <div className='mt-6 flex items-center justify-between'>
                      ...
                      <button className='bg-orange hover:bg-opacity-80 rounded-sm px-4 py-2 text-white capitalize'>
                        Xem giỏ hàng
                      </button>
                    </div>
                  </div>
