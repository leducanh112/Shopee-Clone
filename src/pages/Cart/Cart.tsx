        ...
        {extendedPurchases.length > 0 ? (
          <>
            ...
            <div className='sticky bottom-0 z-10 mt-8 flex flex-col rounded-sm border border-gray-100 bg-white p-5 shadow sm:flex-row sm:items-center'>
              ...
              <div className='mt-5 flex flex-col sm:mt-0 sm:ml-auto sm:flex-row sm:items-center'>
                ...
                <Button
                  className='mt-5 flex h-10 w-52 items-center justify-center bg-red-500 text-sm text-white uppercase hover:bg-red-600 sm:mt-0 sm:ml-4'
          ...
          <div className='text-center'>
            ...
            <div className='mt-5 text-center'>
              <Link
                to={path.home}
                className='bg-orange hover:bg-orange/80 rounded-sm px-10 py-2 text-white uppercase transition-all'
              >
                Mua ngay
              </Link>
            </div>
