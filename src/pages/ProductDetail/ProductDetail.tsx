          ...
          <div className='grid grid-cols-12 gap-9'>
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center'>
                ...
                <button
                  onClick={buyNow}
                  className='fkex bg-orange hover:bg-orange/90 ml-4 h-12 min-w-[5rem] items-center justify-center rounded-sm px-5 text-white capitalize shadow-sm outline-none'
                >
                  Mua ngay
                </button>
              </div>
