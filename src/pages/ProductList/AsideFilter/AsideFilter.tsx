  ...
  return (
    <div className='py-4'>
      <Link to={path.home} className='flex items-center font-bold uppercase'>
        <svg viewBox='0 0 12 10' className='w-3 h-3 mr-3 fill-current'>
      ...
      <div className='my-5'>
        ...
        <form className='mt-2'>
          ...
          <Button className='w-full p-2 uppercase bg-orange text-white text-sm hover:bg-orange/80 flex justify-center items-center cursor-pointer'>
            Áp dụng
          </Button>
        </form>
      </div>
